console.log('my_worker.js run code copied from flutter.js');
...
console.log('my_worker.js call loadEntrypoint');
// Download main.dart.js
_flutter.loader.loadEntrypoint({
    serviceWorker: {
        serviceWorkerVersion: 'dummy-service-worker-version-123',
    }
